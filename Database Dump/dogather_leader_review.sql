...
DROP TABLE IF EXISTS `leader_review`;
...
LOCK TABLES `leader_review` WRITE;
/*!40000 ALTER TABLE `leader_review` DISABLE KEYS */;
/*!40000 ALTER TABLE `leader_review` ENABLE KEYS */;
UNLOCK TABLES;
